...
import { testFeedbackApi } from '../fn/feedback/test-feedback-api';
import { TestFeedbackApi$Params } from '../fn/feedback/test-feedback-api';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `testFeedbackApi()` */
  static readonly TestFeedbackApiPath = '/feedbacks';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `testFeedbackApi()` instead.
   *
   * This method doesn't expect any request body.
   */
  testFeedbackApi$Response(params?: TestFeedbackApi$Params, context?: HttpContext): Observable<StrictHttpResponse<FeedbackResponse>> {
    return testFeedbackApi(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `testFeedbackApi$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  testFeedbackApi(params?: TestFeedbackApi$Params, context?: HttpContext): Observable<FeedbackResponse> {
    return this.testFeedbackApi$Response(params, context).pipe(
