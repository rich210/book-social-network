...
import com.rich.book.common.PageResponse;
import com.rich.book.exception.OperationNotPermittedException;
import com.rich.book.file.FileStorageService;
import com.rich.book.history.BookTransactionHistory;
import com.rich.book.history.BookTransactionHistoryRepository;
...
public class BookService {
    ...
    public PageResponse<BorrowedBookResponse> findAllBorrowedBooks(int page, int size, Authentication connectedUser) {
        ...
        List<BorrowedBookResponse> bookResponses = allBorrowedBooks.stream()
                .map(bookMapper::toBorrowResponse)
                .toList();
        return new PageResponse<>(
                bookResponses,
