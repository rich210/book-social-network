package com.rich.book.auth;

import com.rich.book.email.EmailService;
import com.rich.book.email.EmailTemplateName;
import com.rich.book.role.RoleRepository;
import com.rich.book.security.JwtService;
import com.rich.book.user.Token;
import com.rich.book.user.TokenRepository;
import com.rich.book.user.User;
import com.rich.book.user.UserRepository;
...
public class AuthenticationService {
    ...
    //@Transactional //Remove transactional since if the token is expired it wont send the new token
